...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("I have been created by {uname}")
            ...
            speak("Thanks to {uname}. further It's a secret")
            ...
            speak("What should I write, {uname}")
            note = takeCommand()
            file = open('ai.txt', 'w')
            ...
            wishMe()
            speak("AI 1 point o in your service Mister")
            speak(assname)
